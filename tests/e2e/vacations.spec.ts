        ...
        habits: [
          {
            ...
            override_type: null,
            override_count: null,
            track_during_vacations: tracksVacation,
          },
        ],
      }),
    });
...
test("shows untracked vacation periods in grey and excludes them from consistency", async ({ context, page }) => {
  ...
  await page.locator('.year-grid i[data-period-state="vacation"]').first().hover();
